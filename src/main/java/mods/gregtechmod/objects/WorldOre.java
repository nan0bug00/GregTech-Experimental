...
public enum WorldOre {
    ...
    BAUXITE(Ore.BAUXITE, () -> GregTechConfig.WORLDGEN.bauxite, DimensionType.OVERWORLD, 2, 16, 1, 32, 80, "plains", "forest", "forest_hills", "biomesoplenty:rainforest", "biomesoplenty:highland", "birch_forest", "birch_forest_hills", "biomesoplenty:meadow", "biomesoplenty:redwood_forest", "biomesoplenty:woodland", "twilightforest:twilight_forest", "twilightforest:dense_twilight_forest", "twilightforest:dark_forest", "twilightforest:enchanted_forest", "biomesoplenty:seasonal_forest", "biomesoplenty:quagmire", "biomesoplenty:orchard", "biomesoplenty:pasture", "biomesoplenty:mystic_grove", "biomesoplenty:marsh", "biomesoplenty:maple_woods", "biomesoplenty:grove", "biomesoplenty:grassland", "biomesoplenty:fungi_forest", "biomesoplenty:coniferous_forest", "biomesoplenty:cherry_blossom_grove", "traverse:flatlands", "traverse:plains_plateau", "traverse:rocky_edge", "traverse:autumnal_woods", "traverse:autumnal_wooded_hills", "traverse:wooded_plateau", "traverse:coniferous_forest", "traverse:coniferous_wooded_hills", "traverse:wooded_island", "traverse:woodlands"),
    TETRAHEDRITE(Ore.TETRAHEDRITE, () -> GregTechConfig.WORLDGEN.tetrahedrite, DimensionType.OVERWORLD, 1, 32, 5, 32, 100, "jungle", "jungle_hills", "swampland", "mushroom_island", "mushroom_island_shore", "extreme_hills", "smaller_extreme_hills", "biomesoplenty:bog", "biomesoplenty:overgrown_cliffs", "biomesoplenty:volcanic_island", "traverse:lush_swamp", "traverse:mini_jungle"),
    CASSITERITE(Ore.CASSITERITE, () -> GregTechConfig.WORLDGEN.cassiterite, DimensionType.OVERWORLD, 1, 32, 10, 32, 100, "taiga", "taiga_hills", "ice_flats", "ice_mountains", "mushroom_island", "mushroom_island_shore", "extreme_hills", "smaller_extreme_hills", "biomesoplenty:alps", "biomesoplenty:glacier", "biomesoplenty:tundra", "biomesoplenty:volcanic_island", "traverse:cliffs", "traverse:rolling_hills", "traverse:high_coniferous_forest", "traverse:snowy_coniferous_forest", "traverse:snowy_coniferous_wooded_hills", "traverse:snowy_high_coniferous_forest"),
